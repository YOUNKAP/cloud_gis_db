          ...
          <se:TextSymbolizer>
            ...
            <se:LabelPlacement>
              <se:PointPlacement>
                ...
                <se:Displacement>
                  <se:DisplacementX>5.66</se:DisplacementX>
                  <se:DisplacementY>5.66</se:DisplacementY>
                </se:Displacement>
              </se:PointPlacement>
            </se:LabelPlacement>
            <se:Fill>
            ...
            <se:VendorOption name="maxDisplacement">9</se:VendorOption>
          </se:TextSymbolizer>
        </se:Rule>
      </se:FeatureTypeStyle>
    </UserStyle>
